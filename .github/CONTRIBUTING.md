...
Before you ask a question, search for existing [Discussions](https://github.com/Strappazzon/td2-map-brooklyn/discussions/categories/questions) that might help you.  
...
If you then still need to ask a question and need clarification you can [create a discussion](https://github.com/Strappazzon/td2-map-brooklyn/discussions/new?category=questions).
...
- Take a look at the [issues](https://github.com/Strappazzon/td2-map-brooklyn/issues) first to make sure your issue/feature hasn't been reported/requested before.  
...
```sh
git clone https://github.com/Strappazzon/td2-map-brooklyn.git
cd td2-map-brooklyn/
bundle install
```
...
Fixes: https://github.com/Strappazzon/td2-map-brooklyn/issues/513
```
